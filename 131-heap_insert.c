...
heap_t *heap_insert(heap_t **root, int value)
{
	 ...
	 * Example -
	 * If there are 15 nodes in a complete tree, there are 7 leaves on
	 * the 4th tier of the tree. 7 is 0111 in binary. 1 corresponds to
	 * right, 0 to left.
 ...
 * @tree: tree whose size is being measured
 *
